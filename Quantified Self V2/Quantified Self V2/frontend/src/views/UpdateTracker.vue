<template>
    <router-link :to="`/trackers/{{u_id}}`" style="text-decoration: none;"><h2 style="text-align:right">Back to Trackers</h2></router-link>

    <h1 style="margin-top: 107px; text-align: center;">Update Tracker</h1>
