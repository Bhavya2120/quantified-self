<template>
    ...
    <form @submit.prevent="submit" style="margin-right: 522px;margin-top: 29px; margin-left: 519px" method="POST">
        <div class="form-group">
          <label for="exampleInputEmail1" required style="color:  ;">Enter a note:</label>
        ...
        <div class="form-group" v-if="this.trackertype==='Numerical'" >
            <label for="exampleInputPassword1" required style="color:  ;">Enter the Numerical value:</label>
